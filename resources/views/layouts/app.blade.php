...
<head>
    ...
    <title>{{ config('app.name', 'WATER METER') }}</title>
<Style> 
body {
...
<script src="https://code.getmdl.io/1.2.1/material.min.js"> 
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.css.map" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/fonts/fontawesome-webfont.svg" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/fonts/fontawesome-webfont.eot" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/fonts/fontawesome-webfont.ttf" rel="stylesheet">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.min.js" integrity="sha384-Atwg2Pkwv9vp0ygtn1JAojH0nYbwNJLPhwyoVbhoPwBhjQPR5VtM2+xf0Uwh9KtT" crossorigin="anonymous"></script>
  ...
  <script src = "https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js">  </script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/d3/4.2.3/d3.js"> 
</script> 
    <!-- Fonts -->
...
<body>
    ...
    <div id="app">
         <nav class="navbar navbar-expand-md shadow" style="background:#161252" >
            <div class="container">
                <a class="navbar-brand" style="font-size:2rem;color:white">
                  <span style="color:#ff6384; font-size:2.5rem">W</span >ATER <span style="color:#3fabd4">M</span>ETER 
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto" style="background: #3fabd4;">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <!-- <a id="navbarDropdown" class=" dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:1.5rem" v-pre>
  ...
  class AnalogTank {
    constructor($this, config) {
      let defaults = {
        ...
        fillMaxValue: 150, // maximum possible value for the main text.
...
function setTwoText() {
  tank.setSupportLabelText(getNow(), "الساعة الآن ");
}
function fillColor() {
...
var myChart = new Chart(ctx, {
    type: 'line',
    data: {
        labels: ['الأسبوع الأ,ل ', 'الأسبوع الثاني', 'الأسبوع الثالث', 'الأسبوع الرابع', 'الأسبوع الحالي'],
        datasets: [{
            label: 'متوسط الصرف للعائلات المشابهة ',
